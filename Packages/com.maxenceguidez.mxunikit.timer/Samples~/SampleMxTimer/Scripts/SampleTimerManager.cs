...
namespace MxUnikit.Timer.Samples.SampleMxTimer
{
    /// <summary>
    /// Main sample manager that sets up the scene and provides common UI elements.
    ...
    public class SampleTimerManager : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            GUI.Label(new Rect(10, 5, 400, 25), "<b>MxTimer Sample - All Features</b>", new GUIStyle(GUI.skin.label) { richText = true, fontSize = 18 });
